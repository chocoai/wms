...
(function(){
    ...
    // <video class="x-video-player" id="youku-html5player-video" style="width: 100%; height: 100%; display: none; position: relative;"></video>

        $G("preview").innerHTML = '<div class="previewMsg"><span>'+lang.urlError+'</span></div>'+
        '<video class="previewVideo" style="width: 100%; height: 100%;" ' +
            ' src="' + conUrl + '"' +
            ' width="'+300+'"' +
            ' height="' + 280  + '"' +
        '</video>';
