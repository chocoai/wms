...
var provinceList = [
	...
	{name:'湖北省', cityList:[
		{name:'武汉市', areaList:['江岸区','江汉区','硚口区','汉阳区','武昌区','青山区','洪山区','东西湖区','东湖高新区','经济开发区','汉南区','蔡甸区','江夏区','黄陂区','新洲区']},
		...
		{name:'襄阳市', areaList:['襄城区','樊城区','襄阳区','南漳县','谷城县','保康县','老河口市','枣阳市','宜城市']},
	...
	{name:'香港特别行政区', cityList:[
		{name:'香港特别行政区',areaList:['中西区','东区','南区','湾仔区','九龙城区','观塘区','深水埗区','黄大仙区','油尖旺区','离岛区','葵青区','北区','西贡区','沙田区','大埔区','荃湾区','屯门区','元朗区']}
	]},
	{name:'澳门特别行政区', cityList:[
		{name:'澳门特别行政区',areaList:['澳门半岛','花地玛堂区','圣安多尼堂区','大堂区','望德堂区','风顺堂区','澳门离岛','嘉模堂区','圣方济各堂区']}
	]}
];