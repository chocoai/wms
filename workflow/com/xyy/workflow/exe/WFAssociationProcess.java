...
public class WFAssociationProcess extends AbstractNodeProcessor {
	...
	public void execute(ExecuteContext ec) throws Exception {
		...
		if(subPd==null){
			throw new NodeProcessorExecuteException(ec,2451);
		}
		...
		if(subProcess==null){
			throw new NodeProcessorExecuteException(ec,2452);
		}
