...
public class TCWFEnd implements IEvents {
	...
	public void doWork(String tableName,String BillID){
		...
		Db.update("update xyy_erp_dic_shangpinjibenxinxi set tingcai=? where shangpinbianhao in ("+str.toString()+")", details_record.getInt("shenqingxingzhi"));
		}
}
