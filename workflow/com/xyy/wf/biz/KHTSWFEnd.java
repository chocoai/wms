...
public class KHTSWFEnd implements IEvents {
	...
	public void doWork(String tableName,String BillID){
		...
		for(int i=0;i<dlist.size();i++){
			...
			str.append(dlist.get(i).getStr("kehubianhao")+"'");
		}
		Db.update("update xyy_erp_dic_kehujibenxinxi set tingshou=? where kehubianhao in ("+str.toString()+")", details_record.getInt("shenqingxingzhi"));
		}
}
