...
/**
 * 打印块设置
 * <PrintBlock Area="Head|Footer|DtlData" Layout="Grid" Rows="" Cols="" S=""
 * DataTableKey="tableKey" >
 * 
 * @author evan
 *
 */
@XmlComponent(tag = "PrintBlock", type = PrintBlock.class)
public class PrintBlock {
	...
	public static class Col {
		...
		private String text;
		private String colExper;

		@XmlText(name = "colExper")
		public String getColExper() {
			return colExper;
		}

		public void setColExper(String colExper) {
			this.colExper = colExper;
		}

		@XmlAttribute(name = "ifSzToDaXie", tag = "DaXie", type = boolean.class)
		public boolean getIfSzToDaXie() {
			return ifSzToDaXie;
		}

		public void setIfSzToDaXie(boolean ifSzToDaXie) {
			this.ifSzToDaXie = ifSzToDaXie;
		}
