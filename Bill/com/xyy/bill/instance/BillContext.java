 ...
 *
 */
public class BillContext implements Context,IRestorable {
	...
	public DataSetInstance getDataSetInstance(){
		return (DataSetInstance)this.get("$model");
	}
	...
	public void addError(String no,String message){
		errors.add(new ErrorMsg(no, message));
	}
	
	public String getErrorJSON() {
		JSONArray result=new JSONArray();
		for(ErrorMsg msg:errors){
			result.add(msg.getJSONObject());
		}
